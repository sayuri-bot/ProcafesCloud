      ...
      <div class="mb-4">
        ...
        <div class="form-check mb-2">
          <input class="form-check-input" type="radio" name="method" id="pay_mercadopago"
                 value="mercadopago" <?php echo e(old('method','mercadopago')==='mercadopago' ? 'checked' : ''); ?>>
        ...
        <div class="form-check">
          <input class="form-check-input" type="radio" name="method" id="pay_cash"
                 value="efectivo" <?php echo e(old('method')==='efectivo' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="summary-section">
      ...
      <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">
          <div class="d-flex align-items-center gap-3">
            <img src="<?php echo e($imgUrl); ?>" alt="<?php echo e($item['name'] ?? 'Producto'); ?>"
                 style="width:56px;height:56px;object-fit:cover;border-radius:8px;">
            <div>
              <div class="fw-semibold"><?php echo e($item['name'] ?? 'Producto'); ?></div>
              <small class="text-muted">x<?php echo e($qty); ?></small>
            </div>
          </div>
          <span class="fw-semibold">S/ <?php echo e($money($lineGross)); ?></span>
        </li>
    ...
    <div class="summary-item">
      <span>Subtotal</span>
      <strong>S/ <?php echo e($money($subtotalBase)); ?></strong>
    </div>
    <div class="summary-item">
      <span>IGV (18%)</span>
      <strong>S/ <?php echo e($money($igvTotal)); ?></strong>
    </div>
    <div class="summary-total">
      <span>Total</span>
      <span>S/ <?php echo e($money($totalFinal)); ?></span>
    </div>
  </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u591048471/domains/pro-cafes.com/procafes/resources/views/checkout/index.blade.php ENDPATH**/ ?>